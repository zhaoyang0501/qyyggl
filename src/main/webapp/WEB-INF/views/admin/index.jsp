                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">调任管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="leave/index" >调任查询</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="leave/create">调任登记</a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">工资管理 </span><span class="label label-warning pull-right">16</span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">员工管理 </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
 						...
 						<li>
                        <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">员工中心 </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="usercenter/myleave">我的调任</a>
                             <li><a class="J_menuItem" href="usercenter/mytran">我的培训</a>
                             <li><a class="J_menuItem" href="usercenter/mypay">我的工资</a>
                            </li>
                        </ul>
                    </li>
